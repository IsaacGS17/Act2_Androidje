...
class Empresa extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('EMPRESA: Registro Civil '),
      ), //findeappbar
      body: Center(
        child: Text("Seccion Empresa Isaac"),
      ), //finbody
    ); //fin de scaffold
  } //fin widget context
...
class Productos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('PRODUCTOS de Registro Civil '),
      ), //findeappbar
      body: Center(
        child: Text("Seccion Productos Isaac"),
      ), //finbody
    ); //fin de scaffold
  } //fin widget context
...
class Contactos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('CONTACTOS Registro Civil'),
      ), //findeappbar
      body: Center(
        child: Text("Seccion Contactos Isaac"),
      ), //finbody
    ); //fin de scaffold
  } //fin widget context
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.cyan, image: DecorationImage(image: NetworkImage("https://github.com/IsaacGS17/Mis_imagenes/blob/main/arton18305.jpg?raw=true"), alignment: Alignment.topCenter),
            ), //fin box decoration
